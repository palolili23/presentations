...
data_no_cens <- tibble::tribble(
  ...
  1L,    12L,      "Quit smoking",            NA,
  2L,    6L,      "Quit smoking",  "Dementia dx",
  3L,   12L,      "Quit smoking",            NA,
  4L,    12L,      "Quit smoking",            NA,
  5L,   12L,      "Quit smoking",            NA,
  6L,    8L, "Control",  "Dementia dx",
  7L,    12L, "Control",  NA,
  8L,   10L, "Control",            "Dementia dx",
  9L,    12L, "Control",            NA,
  10L,    4L, "Control",       "Dementia dx"
)
...
fig_no_cens <- data_no_cens  %>% 
  ...
  coord_flip() +
  scale_color_manual(values = c("#2a7f94", "#e4a803"),   breaks = c("Quit smoking", "Control"),) +
  scale_shape_manual(values = c("Dementia dx" = 15), na.translate = FALSE) +  
...
ggsave("line_graph_no_cens.png", plot = fig_no_cens, 
       path = here::here("2025_time_ad_part_one","figs"),
...
data_cens <- tibble::tribble(
  ~id, ~time,      ~Treatment,           ~Event,
  1L,    4L,      "Quit smoking",            "LTFU",
  2L,    6L,      "Quit smoking",  "Dementia dx",
  3L,   9L,      "Quit smoking",            "LTFU",
  4L,    1L,      "Quit smoking",            "LTFU",
  5L,   12L,      "Quit smoking",            NA,
  6L,    8L, "Control",  "Dementia dx",
  7L,    11L, "Control",  "LTFU",
  8L,   10L, "Control",            "Dementia dx",
...
fig_cens <- data_cens_proc %>% 
  ...
  coord_flip() +
  scale_color_manual(values = c("#2a7f94", "#e4a803"),   breaks = c("Quit smoking", "Control"),) +
  scale_shape_manual(values = c("Dementia dx" = 15, "LTFU" = 7), na.translate = FALSE) +  
...
data_comp_event <- tibble::tribble(
  ~id, ~time,      ~Treatment,           ~Event,
  1L,    3L,      "Quit smoking",            "Death",
  2L,    6L,      "Quit smoking",  "Dementia dx",
  3L,   5L,      "Quit smoking",            "Death",
  4L,    8L,      "Quit smoking",           "LTFU",
  5L,   12L,      "Quit smoking",            NA,
  6L,    8L, "Control",  "Dementia dx",
  7L,    6L, "Control",  "Death",
  8L,   10L, "Control",            "Dementia dx",
...
fig_comp_events <- data_comp_event %>% 
  ...
  scale_shape_manual(values = c("Dementia dx" = 15, LTFU = 7, Death = 8), na.translate = FALSE) +
  scale_linetype_manual(name = "", values = c("Unobserved outcome" = "dotted")) +
  scale_y_continuous(breaks = seq(0, 12, 1), expand = c(0,0), limits = c(0,13)) +
  theme_minimal() +
  theme(
